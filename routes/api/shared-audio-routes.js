...
router.get('/sharedaudio', async (req, res) => {
  try {
...
router.get('/sharedaudio/:id', async (req, res) => {
try {
...
router.post('/sharedaudio', async (req, res) => {
  try {
...
router.put('/sharedaudio/:id', async (req, res) => {
  try {
...
router.delete('/sharedaudio/:id', async (req, res) => {
  try {
